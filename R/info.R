create_info <- function(beta_date){
    ...
    pars_info <- data.frame(
        ...
        initial = c(0.025,0.02,0.024,0.02,0.024,2.8,1,330,0.400626705/2,0.316,3.5,500,5.25,530,0.5,0.5,0.5,0.5),
        min = c(rep(0,n_beta),0.25,1,305,0,0,2,490,3,515,0,0,0,0),
        max = c(rep(1,n_beta),4,10,345,1,1,6,512,9,540,1,1,1,1),
