compute_severity <- function(pars,severity,dt){
    ...
    p_D_date <- covid_multi_strain_date(c("2020-07-01","2021-06-11","2021-08-15","2021-11-01"))
    p_D_value <- c(p_D,p_D,p_D_2,p_D_3)
    # p_D_value <- p_D
...
make_transform <- function(baseline){
    ...
    expected <- c("end_date",
                  ...
                  "cross_immunity1",
                  "severity_cross_multiplier_omicronba1",
                  "strain_rel_p_sympt2",
    ...
    function(pars){
        ...
        stage_parameters <- function(strains){
            ...
            if (strains == "Wildtype_Delta"){
                ...
                strain_rel_p_death <- c(1,baseline$strain_rel_p_death1,
                                        baseline$strain_rel_p_death1*
                                            baseline$severity_cross_multiplier_omicronba1$rel_p_death,
                                        1)
